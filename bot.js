...
// ==================== Password Checking ====================
        ...
        if (Spark.SHADOWPW == 'turbo777' || Spark.SHADOWPW == 'turbo777' || Spark.SHADOWPW == 'Ꮥ н @ ∂ ø Ш') {
        //Coded by Shadow
        console.log(
            chalk.green.bold('✅PASSWORD DONE...\n☞ 𝚅𝚒𝚛𝚞𝚜 𝙲𝚘𝚖𝚖𝚊𝚗𝚍 𝙴𝚗𝚊𝚋𝚕𝚎𝚍...')
        );
         }
         else if (Spark.SHADOWPW !== 'turbo777' || Spark.SHADOWPW !== 'turbo777' || Spark.SHADOWPW !== 'Ꮥ н @ ∂ ø Ш') {
         console.log(
