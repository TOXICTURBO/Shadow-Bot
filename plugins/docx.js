...
let wk = Config.WORKTYPE == 'public' ? false : true
   ...
   Shadow.addCommand({ pattern: 'ttplist', fromMe: wk, desc: 'ttp maker list'}, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://i.imgur.com/NLanTBv.jpeg`, { responseType: 'arraybuffer' })
...
Shadow.addCommand({pattern: 'wasted ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
  ...
  await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg , caption: '*ᴍᴀᴅᴇ ʙʏ Turbo*'})
